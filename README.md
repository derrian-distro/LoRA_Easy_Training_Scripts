...
| save_at_n_epochs        | int       | NO       | This is a mis-naming of save_every_n_epochs, which saves epochs every n epochs, so save_at_n_epochs = 1 means that it saves every epoch                                                                                                                                  |
...
| max_bucket_resolution   | int       | YES      | the maximum bucker size when creating buckets                                                                                                                                                                                                                            |
