...
class ExtraItem(QtWidgets.QWidget):
    ...
    def __init__(
        ...
        super(ExtraItem, self).__init__(parent)
        ...
        self.is_dataset_toggle = QtWidgets.QCheckBox()
        self.is_dataset_toggle.setToolTip("There is no error checking on this.")
        self.is_dataset_toggle.setText("Dataset Arg")
        self.is_dataset_toggle.setChecked(is_dataset)

        self.delete_button = QtWidgets.QPushButton()
        self.delete_button.setIcon(QtGui.QIcon(str(Path("icons/trash-2.svg"))))
        ...
        self.layout().addWidget(self.is_dataset_toggle)
        ...
        self.is_dataset_toggle.clicked.connect(self.dataset_toggled)
    ...
    def dataset_toggled(self, value: bool):
    ...
    def get_arg(self):
        return self.arg_name, self.arg_value, self.is_dataset
